...
const Experience = () => {
  ...
  return (
    <div name="experience" className='dark:bg-gradient-to-b from-gray-800 to-black w-full h-screen md:mt-[11rem]'>
        <div className='max-w-screen-lg mx-auto flex flex-col
        justify-center w-full h-full text-gray-500 font-bold text-xl'>
            <div>
                <p className='text-4xl font-bold border-b-4 border-gray-500 p-2 inline md:mt-[11rem]'>Experience</p>
